...
from infinity.dataset.dataset_t2i_iterable import T2IIterableDataset,T2IIterableDataset_deg
...
def build_t2i_dataset(
    ...
    if args.use_streaming_dataset:
        ...
        elif args.data_deg == "realesrgan" or args.data_deg == "realesrgan_light":
            return T2IIterableDataset_deg(
                data_path, 
                max_caption_len=max_caption_len, 
                short_prob=short_prob, 
                load_vae_instead_of_image=load_vae_instead_of_image, 
